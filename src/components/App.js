  ...
  return (
    <div className = "page">
      <div className="page__content">
        ...
        <Footer />
        <PopupWithForm buttonText="Сохранить" isOpen={editProfileOpen} setActive={setEditProfileOpened} onClose={closeAllPopups} title ={'Редактировать профиль'} name={'edit-profile'}>
        ...
        <PopupWithForm buttonText="Сохранить" isOpen={editAvatarOpen} setActive={setEditAvatarOpened} onClose={closeAllPopups} title={'Обновить аватар'} name={'new-avatar'}>
          <label className = "form__input-field">
