...
function Main({onCardDelete, onCardLike, onCardClick, onAddPlace, onEditAvatar, onEditProfile }) {
    ...
    <main>
      ...
      <section className="elements">
        {currentCard.map((item) => (
          <Card onCardDelete={onCardDelete} onCardLike={onCardLike} onCardClick={onCardClick} card={item} key={item._id} user={currentUser._id} />
        )
        )}
